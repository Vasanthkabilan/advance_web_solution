                  ...
                  <thead class=" text-primary">
                    ...
                    <tbody>
                      <?php 
                        ...
                        <a href='manageinvest.php?user_id=$user_id&action=delete' type='button' rel='tooltip' title='' class='btn btn-danger btn-link btn-sm' data-original-title='Delete User'>
