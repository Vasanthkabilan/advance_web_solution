...
$result=mysqli_query($con,"select id, name, riskrating, producttype, instrument, sector, region, country, currency, content, tag from approve where id='$user_id'")or die ("query 1 incorrect.......");

list($user_id, $name, $riskrating, $producttype, $instrument, $sector, $region, $country,  $currency, $content, $tag)=mysqli_fetch_array($result);
...
mysqli_query($con,"update `approve` set name='$name', riskrating='$riskrating', producttype='$producttype', instrument='$instrument', sector='$sector', region='$region', country='$country',  currency='$currency', content='$content', tag='$tag' where id='$user_id'")or die("Query 2 is inncorrect..........");
          ...
          <div class="row">
            <div class="col-md-12 ">
             <h2 class="mt-5">Update Record</h2>
              <form action="editapprove.php" name="form" method="post" enctype="multipart/form-data">
